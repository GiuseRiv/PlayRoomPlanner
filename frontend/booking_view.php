        ...
        <div class="card-body">
          ...
          <div class="mb-4 p-4 bg-light rounded-3 border">
              ...
              <div class="d-flex justify-content-between align-items-end mb-2">
                  <div>
                    <span class="text-muted small text-uppercase fw-bold" style="font-size: 0.7rem; letter-spacing: 1px;">
                        Occupazione Posti
                    </span>
              ...
              <div class="progress shadow-inset bg-white border" style="height: 24px; border-radius: 12px;">
                  <div id="occupancyBar" 
                       ...
                       role="progressbar" 
                       style="width: 0%; border-radius: 12px; transition: width 0.8s ease-in-out;">
                  </div>
              </div>

              <div class="text-muted small mt-2 d-flex align-items-center">
                <i class="bi bi-info-circle me-1"></i>
                <span class="fst-italic" style="font-size: 0.85rem;">
                   Il conteggio include l'organizzatore (1) e gli invitati che hanno confermato.
                </span>
              </div>
          </div>

          <div class="alert alert-light border mb-4 p-3 d-flex align-items-center shadow-sm">
             <div class="me-3 bg-white p-2 rounded-circle border text-primary">
          ...
          <div id="tableContainer" class="d-none">
              <div class="d-flex align-items-center mb-2 mt-4">
                  ...
                  <div class="ms-auto">
                      <span class="badge bg-light text-dark border fw-normal">Dettaglio completo</span>
                  </div>
              </div>
              ...
              <div class="table-responsive border rounded bg-white">
                 <table class="table table-hover align-middle mb-0">
                   <thead class="table-light small">
                     <tr>
                       <th class="ps-3 py-3">Nominativo</th>
                       <th>Contatto Email</th>
                       <th>Ruolo</th>
                       <th>Stato Invito</th>
                     </tr>
                   </thead>
                   <tbody id="invTbody" class="bg-white">
                       </tbody>
                 </table>
              </div>
          </div>
